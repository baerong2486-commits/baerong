...
const SUPABASE_ANON = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJ6YW5xeWNydWdhZHNweXJydmtmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODUwMzAzMDgsImV4cCI6MjEwMDYwNjMwOH0.IHkIxkwTi0l5xzWOOkMaAtwTiO0uN--GiXwIVnUX2Mc';

// ── Supabase 클라이언트 초기화 ──
/* CDN 로드 실패/네트워크 차단 시에도 페이지가 죽지 않도록 방어 */
...
if (!db) console.warn('[supabase] 클라이언트 초기화 실패 — 기본값으로 표시됩니다.');
